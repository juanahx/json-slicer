(function() {
    ...
    var treeviewViewModel = {
        ...
        updateVisibleLines: function() {
            var maxVisibleLines = Math.floor($(".control-panel").height() / 20);
    ...
    window.slicer.plugins.array = {
        ...
        click: function(node) {
            if(_.isArray(node.value)) {
                ...
                var columns = _.sortBy(_.keys(keys), function(key) {return key.toLowerCase();});
